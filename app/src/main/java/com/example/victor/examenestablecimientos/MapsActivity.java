...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(Double.valueOf(getIntent().getExtras().getString("altitud")), Double.valueOf(getIntent().getExtras().getString("latitud")));
        mMap.addMarker(new MarkerOptions().position(sydney).title(getIntent().getExtras().getString("nombre")));
